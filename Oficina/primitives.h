...
#define gp_circle_threshold8 8
#define gp_circle_threshold16 50
#define gp_circle_threshold24 180
...
//9-40-114, 6-28-78, 3-16-42
#define gp_rounded_res 5 //resolution
#define gp_rounded_len 24// 4*(res + 1)
#define gp_rounded_tri 66// 3 * len -6
